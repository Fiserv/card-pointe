...
4) Configure your app to [handle the response object](https://developers.google.com/pay/api/android/guides/tutorial#paymentdata). See Tokenizing Google Pay Data for more information.
