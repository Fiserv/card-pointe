...
| fee_value | 1, 3, 6 | If applicable, the surcharge rate applied to the transaction. For example, `300` when a 3.0% surcharge is successfully applied or `0` if the surcharge was waived, bypassed, or not applicable. |
